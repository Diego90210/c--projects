...
int main(){
    ...
    cout<<"El siguiente programa será un sistema completo de gestión de socios para el club, permitiendo registrar, modificar, consultar y realizar operaciones relacionadas con los socios, asociados, consumos y facturas."<<endl;
